...
link_commonrc() {
  link_to_home "Commonrc" "rc_files/commonrc" ".commonrc"

  link_to_home "Commonrc Extra" "rc_files/commonrc-extra" ".commonrc-extra"
}

# Bashrc
link_bashrc() {
  link_to_home "Bashrc" "rc_files/bashrc" ".bashrc2"
...
link_inputrc() {
  if [[ "$OSTYPE" == "darwin"* ]]; then
    link_to_home "Inputrc (mac)" "rc_files/inputrc.mac" ".inputrc"
  else
    link_to_home "Inputrc" "rc_files/inputrc" ".inputrc"
  fi
}
...
link_base16colors() {
  ...
  link_to_home "Base16 Colors" "rc_files/base16colors" ".base16colors"
}
...
link_lscolors() {
  ...
  link_to_home "LS Colors" "rc_files/lscolors" ".lscolors"
}

link_git_config() {
  link_to_home "Git config" "rc_files/gitconfig" ".gitconfig"
}
