...
" Based on Monokai tasty by:
" Patrick Stockwell <mail@deciphr.net>
"
...
" Config - monokai_pro_italic {{{
" If user has not set italics, set based on terminal support
if !exists('g:monokai_pro_italic')
  if has('gui_running') || $TERM_ITALICS == 'true'
    let g:monokai_pro_italic = 1
  else
    let g:monokai_pro_italic = 0
  endif
endif

if g:monokai_pro_italic
...
" Config - monokai_pro_highlight_active_window {{{
if !exists('g:monokai_pro_highlight_active_window')
  let g:monokai_pro_highlight_active_window = 0
endif
if g:monokai_pro_highlight_active_window == 1
